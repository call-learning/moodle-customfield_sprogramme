...
$string['departmentheadrolename_desc'] = 'Chef de département (nom court) - Les utilisateurs avec ce rôle seront notifiés des demandes de modification de programme et pourront les certifier (visa).';
...
$string['programme:supports'] = 'Supports pédagogiques essentiels';
...
$string['reeditrfc'] = 'Continuer à modifier';
