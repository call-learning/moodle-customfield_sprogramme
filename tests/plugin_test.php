...
final class plugin_test extends \advanced_testcase {
    ...
    public function setUp(): void {
        ...
        $cfgenerator = $this->getDataGenerator()->get_plugin_generator('customfield_sprogramme');
        ...
        $this->cfdata[2] = $cfgenerator->add_instance_data($this->cfields[1], $this->courses[2]->id, 1);
    ...
    public function test_initialise(): void {
        ...
        $this->assertTrue($f instanceof \customfield_checkbox\field_controller);
        ...
        $this->assertTrue($d instanceof \customfield_checkbox\data_controller);
