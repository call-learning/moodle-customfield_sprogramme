...
use customfield_sprogramme\external\submit_rfc;
 ...
 * @covers \customfield_sprogramme\external\submit_rfc
 */
final class submit_rfc_test extends \externallib_advanced_testcase {
     ...
     * @return mixed
     */
    protected function submit_rfc(...$params) {
        $submitrfc = submit_rfc::execute(...$params);
        return external_api::clean_returnvalue(submit_rfc::execute_returns(), $submitrfc);
    }
