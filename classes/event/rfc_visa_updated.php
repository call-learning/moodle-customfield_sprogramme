...
/**
 * An rfc has been accepted.
 *
 * @package    customfield_sprogramme
 * @copyright  2023 - CALL Learning - Laurent David <laurent@call-learning.fr>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class rfc_visa_updated extends \core\event\base {
    /**
     * Returns the event name.
     * @return string
     */
    public static function get_name() {
        return get_string('event_rfc_visa_updated', 'customfield_sprogramme');
    }
    ...
    public function get_description() {
        return "The user with id {$this->userid} has updated the visa an rfc with id {$this->objectid}.";
    }
