 ...
 */
class rfc_accepted extends \core\event\base {
    /**
     * Returns the event name.
     * @return string
     */
    public static function get_name() {
        return get_string('event_rfc_accepted', 'customfield_sprogramme');
    }
    ...
    public function get_description() {
        return "The user with id {$this->userid} has accepted an rfc with id {$this->objectid}.";
    }
