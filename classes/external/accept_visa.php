 ...
 */
class accept_visa extends external_api {
    /**
     ...
     * @return bool
     */
    public static function execute(int $rfcid, string $comment): bool {
        global $USER;
        ...
        if (!$visa->can_visa($USER->id)) {
            throw new \moodle_exception('visaacceptancenotallowed', 'customfield_sprogramme');
        }
        return $visa->accept_visa($USER->id, $comment);
    }
    ...
    public static function execute_returns(): external_value {
        return new external_value(PARAM_BOOL, 'Accepted');
    }
}
