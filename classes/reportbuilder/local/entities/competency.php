...
class competency extends base {
    ...
    protected function get_all_columns(): array {
        ...
        $columns[] = (new column(
            'uniqueid',
            new lang_string('competency:uniqueid', 'customfield_sprogramme'),
        ...
        $columns[] = (new column(
            'type',
            new lang_string('competency:type', 'customfield_sprogramme'),
            $this->get_entity_name()
        ))
            ->add_joins($this->get_joins())
            ->set_type(column::TYPE_TEXT)
        ...
        $columns[] = (new column(
            'parent',
            new lang_string('competency:parent', 'customfield_sprogramme'),
            $this->get_entity_name()
        ))
            ->add_joins($this->get_joins())
            ->set_type(column::TYPE_TEXT)
        ...
        $columns[] = (new column(
            'name',
            new lang_string('competency:name', 'customfield_sprogramme'),
            $this->get_entity_name()
        ))
            ->add_joins($this->get_joins())
            ->set_type(column::TYPE_TEXT)
        ...
        $columns[] = (new column(
            'sortorder',
            new lang_string('competency:sortorder', 'customfield_sprogramme'),
            $this->get_entity_name()
        ))
            ->add_joins($this->get_joins())
    ...
    protected function get_default_entity_title(): lang_string {
        return new lang_string('entity:competency', 'customfield_sprogramme');
    }

    #[\Override]
    protected function get_default_tables(): array {
        return ['customfield_sprogramme_complist'];
    }
}